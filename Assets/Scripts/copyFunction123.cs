...
public class copyFunction123 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    private Canvas canvas;
    private RectTransform rectTransform;
    private CanvasGroup canvasGroup;
    private Vector3 initialPosition; // �O����l��m
    private Copy123 copyScript; // �Ѧ� CopyObjectOnDrop �}��
    ...
    private void Awake()
    {
        ...
        copyScript = FindObjectOfType<Copy123>(); // �M��������� CopyObjectOnDrop �}�����
    }
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (hit.collider != null)
        {
            ...
            if (hitObject.CompareTag("Manipulatable1"))
            {
                ...
                {
                    Debug.Log("great");
                    copyScript.CopyObject(); // �ե� CopyObjectOnDrop ���� CopyObject ��k
                    rectTransform.anchoredPosition = initialPosition;
