...
public class integral : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (hit.collider != null)
        {
            ...
            if (hitObject.CompareTag("fan") || hitObject.CompareTag("fan2") || hitObject.CompareTag("fan3")) // �p�G�S���˴���ؼЪ���A�T�{�g�u�˴��쪺����
            {
    ...
    {
        // count++;
        obj.transform.localScale += new Vector3(0.1f, 0.1f, 0.1f); // ��ۼW�[�Y��
